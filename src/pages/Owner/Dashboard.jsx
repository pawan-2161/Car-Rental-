                ...
                {data.recentBookings.map((booking, index)=>(
                  <div key={index} className='mt-4 flex items-center justify-between'>
                      ...
                      <div className='flex items-center gap-2 font-medium'>
                          ...
                          <p className='px-3 py-0.5 border border-r-borderColor rounded-full text-sm'>{booking.status}</p>
                      </div>
                  </div>
                ))}
              </div>
                {/* monthly revenue */}
              <div className='p-4 md:p-6 mb-15 border border-borderColor rounded-md w-full md:max-w-xs'>
