...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title1 title="Add New Car" subTitle="Fill in details to list a new car for booking, including pricing, availability, and car specification." />
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='flex items-center gap-2 w-full'>
          ...
          <p className='text-sm text-gray-500'>Upload a pictur of your car</p>
        </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div className='flex flex-col w-full'>
                ...
                <input type="text" placeholder='e.g. E-Class, M4...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.model} onChange={e=> setCar({...car, model: e.target.value})}/>
              </div>
            </div>
             ...
             {/* car transmission, fuel_type, seating_capacity  */}
             <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
               <div className='flex flex-col w-full'>
              ...
              <div className='flex flex-col w-full'>
                ...
                <textarea rows={5} placeholder='e.g A luxurious SUV with a spacious interior and a poerful engine.' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e=> setCar({...car, description: e.target.value})}></textarea>
              </div>
